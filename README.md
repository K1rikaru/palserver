...
3. Pull the latest version of the image with `docker pull kirikaru/palworld-dedicated-server:latest`
...
Welcome to Pal Server[v0.1.4.1] kirikaru-docker-generated-20384
